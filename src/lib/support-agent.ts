...
Cuando recomiendes un producto, incluye UNA sola vez al final el path exacto /producto/slug-del-producto (sin escribir "URL" ni repetir el enlace). El sistema lo convertirá en botón "Ver producto".
