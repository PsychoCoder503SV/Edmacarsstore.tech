...
export function ConfirmadoContent({ whatsappDigits }: Props) {
              ...
              {whatsappDigits ? (
                <>
                  ...
                  <span className="font-medium text-white">
                    {formatWhatsAppDisplay(whatsappDigits)}
                  </span>{" "}
                  con tu número de orden <span className="font-mono text-neon-cyan">{data.orderNumber}</span> y
